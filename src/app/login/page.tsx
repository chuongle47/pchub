...
export default function LoginPage() {
  ...
  const handleQuickLogin = async (type: 'member' | 'admin') => {
    const quickEmail = type === 'admin' ? 'admin@pchub.vn' : 'user@pchub.vn';
    const quickPassword = type === 'admin' ? 'admin123' : '123456';

    setEmail(quickEmail);
    setPassword(quickPassword);
    await completeLogin(quickEmail, quickPassword);
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Social Buttons (Vertically Stacked) */}
        ...
        <div style={{
          ...
          <span style={{ padding: '0 14px' }}>HOẶC TIẾP TỤC VỚI EMAIL</span>
          <div style={{ flex: 1, height: '1px', background: '#e2e8f0' }}></div>
        </div>
