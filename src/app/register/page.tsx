...
import { Eye, EyeOff, ArrowRight, User, Mail, Lock, Sparkles, Copy, Check, ShieldCheck } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleCopyPassword = () => {
    if (formData.password && typeof navigator !== 'undefined' && navigator.clipboard) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isGeneratedPass && !hasSavedPassword) {
      setError('Vui lòng tích xác nhận "Tôi đã lưu / ghi nhớ mật khẩu này" trước khi đăng ký');
      return;
    }
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
              <span style={{ fontSize: '12.5px', fontWeight: 600, color: '#334155' }}>Mật khẩu</span>
              <button
                type="button"
              ...
              >
                <Sparkles size={12} color="#2563eb" /> Tạo mật khẩu mạnh
              </button>
            </div>
            <div style={{ position: 'relative' }}>
          ...
          {/* Checkbox & Security alert for Generated Strong Password in Register */}
          {isGeneratedPass && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <ShieldCheck size={18} color={hasSavedPassword ? '#16a34a' : '#2563eb'} />
                  <div>
                    <div style={{ fontSize: '12.5px', fontWeight: 700, color: hasSavedPassword ? '#14532d' : '#1e3a8a' }}>
                      Mật khẩu mạnh đã tạo
                    </div>
                    <div style={{ fontSize: '11px', color: hasSavedPassword ? '#15803d' : '#3b82f6' }}>
                      Hãy sao chép và ghi nhớ mật khẩu này
                    </div>
                  </div>
                </div>
                <button
