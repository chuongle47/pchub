      ...
      try {
        ...
        if (data.products) {
          const mapped = data.products.map((p: any) => {
            ...
            const origPrice = p.original_price || p.originalPrice || getProductOriginalPrice(price, p.slug);
            return {
              id: p.id,
              slug: p.slug,
              name: p.name,
    ...
    <div style={{ background: '#f8fafc', color: '#0f172a', minHeight: '100vh', padding: '24px 0 60px' }}>
      ...
      <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div className="search-layout-grid" style={{ alignItems: 'flex-start' }}>
          ...
          {/* LEFT FILTER SIDEBAR */}
          <aside className={`search-filter-sidebar${isMobileFilterOpen ? ' is-open' : ''}`} style={{
            background: '#ffffff',
            border: '1px solid #e2e8f0',
            borderRadius: '16px',
            padding: '20px',
          ...
          <main>
            ...
            <div className="search-toolbar-header" style={{
              boxShadow: '0 2px 8px rgba(0,0,0,0.02)',
            }}>
            ...
            {loading ? (
              ...
              <div className="search-products-grid" style={{
                display: 'grid',
                ...
                {displayedProducts.map(p => {
                  ...
                  // Grid View Card
                  const saleDiscount = p.saleTag ? parseInt(p.saleTag.replace(/[^0-9]/g, ''), 10) : undefined;
                  return (
                    <ProductCard
                      key={p.id}
                      id={p.id}
