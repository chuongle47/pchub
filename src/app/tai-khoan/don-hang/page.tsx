      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '12px', color: '#64748b', margin: '4px 0 0 0', fontVariantNumeric: 'tabular-nums' }}>{userPhone || 'Chưa cập nhật số điện thoại'}</p>
          </div>
        </div>
        <Link 
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                    <span style={{ fontVariantNumeric: 'tabular-nums', fontWeight: 800, color: '#0f172a', fontSize: '15px' }}>{order.id}</span>
                    <span style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: '5px',
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <span style={{ fontWeight: 800, color: 'var(--color-primary)', fontSize: '17px', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
