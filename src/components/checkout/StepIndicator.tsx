          ...
          <div key={s.label} style={{ display: 'flex', alignItems: 'center' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
              ...
              <div style={{
                ...
                fontWeight: 800,
                background: isDone ? 'var(--color-status-success)' : isCurrent ? 'var(--color-primary)' : '#f1f5f9',
                color: isDone || isCurrent ? '#fff' : '#94a3b8',
                border: isCurrent ? '3px solid #bfdbfe' : isDone ? '3px solid #bbf7d0' : '2px solid #e2e8f0',
                boxShadow: isCurrent ? '0 0 0 4px rgba(0,85,212,0.1)' : 'none',
              ...
              <span style={{
                ...
                color: isDone ? 'var(--color-status-success)' : isCurrent ? 'var(--color-primary)' : '#94a3b8',
                whiteSpace: 'nowrap',
              }}>
                {s.label}
              </span>
