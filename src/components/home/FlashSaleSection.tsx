...
const DEFAULT_FLASH: FlashProduct[] = [
  ...
  { id: 'p-3', name: 'RAM Corsair Dominator Titanium RGB 32GB (2x16GB) DDR5 6000MHz', category: 'RAM - Bộ Nhớ Trong', price: 4290000, originalPrice: 4890000, discount: 12, image: '/images/ram-rgb.jpg', slug: 'corsair-dominator-titanium-rgb-32gb-ddr5' },
  { id: 'p-4', name: 'SSD Samsung 990 PRO 2TB PCIe Gen 4.0 x4 NVMe', category: 'SSD / HDD - Ổ Đĩa Cứng', price: 4690000, originalPrice: 5190000, discount: 10, image: '/images/cpu-box.jpg', slug: 'samsung-990-pro-2tb-nvme' }
];
