...
const DEFAULT_HOT: HotProduct[] = [
  ...
  { id: 'p-3', badge: 'BÁN CHẠY', badgeColor: 'blue', image: '/images/ram-rgb.jpg', category: 'RAM - Bộ Nhớ Trong', name: 'RAM Corsair Dominator Titanium RGB 32GB (2x16GB) DDR5', specs: 'Capacity: 32GB | Speed: 6000MHz', price: 4290000, originalPrice: 4890000, discount: 12, slug: 'corsair-dominator-titanium-rgb-32gb-ddr5' },
  { id: 'p-4', badge: 'HOT', badgeColor: 'red', image: '/images/cpu-box.jpg', category: 'SSD / HDD', name: 'SSD Samsung 990 PRO 2TB PCIe Gen 4.0 x4 NVMe', specs: 'Read: 7450MB/s | Write: 6900MB/s', price: 4690000, originalPrice: 5190000, discount: 10, slug: 'samsung-990-pro-2tb-nvme' }
];
