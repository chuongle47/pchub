    ...
    <section style={{ background: '#f8fafc', padding: '24px 0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          {/* Left text */}
          <div className="promo-banner-left" style={{ position: 'relative', zIndex: 10, padding: '40px 48px', flex: 1 }}>
            <span style={{
              fontSize: '10px',
              fontWeight: 800,
              letterSpacing: '2px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px', flexWrap: 'wrap' }}>
              <Link href="/build-pc" className="form-btn-primary" style={{
                fontSize: '13px',
                padding: '10px 20px',
              }}>
              ...
              <Link href="/community" style={{
                ...
                Xem cộng đồng <ArrowRight size={14} />
              </Link>
            </div>
          ...
          {/* Right visual */}
          <div className="promo-banner-right" style={{
            flexShrink: 0,
            paddingRight: '48px',
            position: 'relative',
            zIndex: 10,
            ...
            <div style={{
              ...
              {[
                ...
                <div key={slot.label} style={{
                  ...
                  {slot.price && (
                    <span style={{ fontSize: '10px', fontVariantNumeric: 'tabular-nums', fontWeight: 800, color: '#818cf8' }}>
                      {slot.price}
                    </span>
                  )}
                </div>
